...
** 
** *****************  Version 3  *****************
** User: Dow          Date: 3/17/99    Time: 6:14p
** Updated in $/Releases/Voodoo3/MT2/3Dfx/devel/H3/minihwc
 ...
 *
 * Downloads a gamma table from Glide that is then impressed upon
 ...
 *
 * Restores the video settings to those of the desktop before glide
 ...
 * out of exclusive mode glide apps.  We do this by calling the same function
